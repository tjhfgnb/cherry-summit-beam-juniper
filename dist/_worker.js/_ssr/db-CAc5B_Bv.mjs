...
//#region node_modules/.nitro/vite/services/ssr/assets/db-CAc5B_Bv.js
var db_CAc5B_Bv_exports = /* @__PURE__ */ __exportAll({
	n: () => ensureDbReady,
	r: () => getPglite,
	t: () => db_exports
});
...
var rawDatabaseUrl = typeof processModule !== "undefined" ? processModule.env.DATABASE_URL : void 0;
var databaseUrl = rawDatabaseUrl && rawDatabaseUrl.trim() ? rawDatabaseUrl : void 0;
/** Cloudflare Workers/Pages — PGLite WASM cannot boot here. */
function isCloudflareRuntime() {
	if (typeof globalThis.HTMLRewriter === "function") return true;
	if (typeof processModule !== "undefined" && processModule.env.CF_PAGES === "1") return true;
	return (typeof navigator !== "undefined" ? navigator.userAgent : void 0) === "Cloudflare-Workers";
}
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_wordbook.sql": _0002_wordbook_default
		});
...
async function createSql() {
	...
	if (isCloudflareRuntime()) throw new Error("Cloudflare needs DATABASE_URL (Neon). PGLite is only for the live preview.");
...
async function getPglite() {
	if (isCloudflareRuntime()) throw new Error("PGLite is not available on Cloudflare. Set DATABASE_URL to a Postgres database.");
...
if (typeof window === "undefined" && dbSource === "pglite" && !isCloudflareRuntime()) globalBoot.__pgBootstrapPromise__ ??= ensureDbReady().catch((err) => {
	globalBoot.__pgBootstrapPromise__ = void 0;
	console.error("[db] PGLite bootstrap failed:", err);
	throw err;
});
//#endregion
export { ensureDbReady as n, getPglite as r, db_CAc5B_Bv_exports as t };
