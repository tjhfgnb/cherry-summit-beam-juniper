...
import { t as GATE_SESSION_MARKER_COOKIE } from "./gate-session-marker-xmFBQyXo.mjs";
import { n as string$1, t as boolean$1 } from "../_libs/zod.mjs";
import { n as ensureDbReady, r as getPglite } from "./db-BY9kKZ5u.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-C_1wLRoH.js
...
function env$2(key) {
	return processModule.env[key]?.trim() || void 0;
}
/**
...
var env$1 = (key) => {
	const value = processModule.env[key]?.trim();
...
var trustedOrigins = explicitBaseURL ? [
	...
	...LOCAL_DEV_ORIGINS,
	"https://*.pages.dev",
	"https://cherry-summit-beam-juniper.pages.dev"
];
...
//#endregion
export { auth, authConfigured, gateIdentityEnabled as t };
