...
import { i as signOut, t as authClient } from "./client-12WPioY0.mjs";
import { a as persistNameForUser, s as subscribeLocalAuth, t as getLocalUser } from "./local-account-DRh4dDBX.mjs";
import { n as hasGateSessionMarker } from "./gate-session-marker-xmFBQyXo.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dzw7iLf_.js
...
function useCurrentUserState() {
	const local = (0, import_react.useSyncExternalStore)(subscribeLocalAuth, getLocalUser, () => null);
...
function LocalBookScope() {
	...
	(0, import_react.useEffect)(() => {
		...
		useWordStore.persist.rehydrate();
	}, [isPending, user]);
	return null;
}
function AuthProvider({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LocalBookScope, {}), children] });
}
...
function isStaticSpa() {
	return typeof document !== "undefined" && document.getElementById("root") !== null;
}
function RootShell({ children }) {
	if (isStaticSpa()) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children });
...
function RootApp() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreviewHostBridge, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}) }) })] });
}
...
var $$splitComponentImporter$4 = () => import("./routes-Dzq8woGm.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./add-B1_r4Kub.mjs");
var Route$5 = createFileRoute("/add")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./login-hEBBf-yj.mjs");
var Route$4 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./practice-Du0w1BBP.mjs");
var Route$3 = createFileRoute("/practice")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./translate-B7Sqhrvb.mjs");
var Route$2 = createFileRoute("/translate")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
async function sessionUserId(request) {
	const { auth } = await import("./server-C_1wLRoH.mjs");
...
var Route$1 = createFileRoute("/api/wordbook")({ server: { handlers: {
	GET: async ({ request }) => {
		try {
...
async function handleAuth(request) {
	try {
		...
		if (new URL(request.url).pathname.includes("get-session")) return new Response("null", {
			status: 200,
			headers: { "content-type": "application/json; charset=utf-8" }
		});
		return new Response(JSON.stringify({ message: "雲端登入目前無法使用，單字仍會存在這台裝置。" }), {
			status: 503,
			headers: { "content-type": "application/json; charset=utf-8" }
		});
	}
...
var rootRouteChildren = {
	...
	TranslateRoute: Route$2.update({
		id: "/translate",
		path: "/translate",
		getParentRoute: () => Route$7
	}),
	ApiWordbookRoute: Route$1.update({
		id: "/api/wordbook",
		path: "/api/wordbook",
		getParentRoute: () => Route$7
	}),
...
//#endregion
export { reviewLabel as a, parseBulkText as c, canonicalizePos as d, formatPos as f, useCurrentUserState as h, isDue as i, POS_BY_KEY as l, togglePosKey as m, cn as n, EN_DISTRACTORS as o, parsePos as p, useWordStore as r, ZH_DISTRACTORS as s, router_exports as t, POS_OPTIONS as u };
