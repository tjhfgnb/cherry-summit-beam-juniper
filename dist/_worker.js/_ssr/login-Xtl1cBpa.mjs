...
import { t as GROK_PROVIDERS } from "./server-fBy9HSH6.mjs";
import { h as useCurrentUserState, m as cn } from "./router-Btse5H2c.mjs";
import { t as Button } from "./button-DeGVyA2Y.mjs";
import { t as Input } from "./input-BE3TB1oA.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-Xtl1cBpa.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "登入後單字本、熟練度與連續天數會跟著帳號走，換裝置也還在。未登入仍可在這台裝置練習。"
					})
				]
			}),
