...
import { p as cn } from "./router-ugn03xlr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/select-circle-DSGlPFSi.js
...
function SelectCircle({ selected, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: cn("flex size-6 items-center justify-center rounded-full border-2 transition-[background-color,border-color,transform] duration-150 ease-out-soft", selected ? "border-accent bg-accent" : "border-faint bg-transparent", className),
		"aria-hidden": true,
